...
namespace Anonim_Function
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            new Debtor("Shirley T. Qualls", DateTime.Parse("March 30, 1932"), "0-12345-6789", "ShirleyTQualls@teleworm.us", "3565 Eagles Nest Drive Woodland, CA 95695", 2414),
            ...
            //var debt = debtors.Where(d =>
            //  {
            //      var mail = d.Email.Split('@')[1];
            //      if (mail == "rhyta.com" || mail == "dayrep.com")
            //      {
            //          return true;
            //      }
            //      else
            ...
            //  })
            //.ToList();
            //debt.ForEach(Console.WriteLine);



            //3) Yashi 26 - dan 36 - ya qeder olan borclulari cixartmag
            //   var debtor = debtors.Where(d =>
            //   {
            ...
            //   })
            //.ToList();
            //   debtor.ForEach(Console.WriteLine);
            ...
            //{
            //    var name = d.FullName;
            //    var phoneNumber = d.Phone;
            //    char ch = '7';
            //    int count = phoneNumber.Count(f => (f == ch));
            //    if (name.Length > 18&&count>=2)
            //    {
            //        return true;
            //    }
            //    else
            ...
            //    if (count == 0)
            //    {
            //        Console.WriteLine($"Name : {d.FullName}  BirthDay : {d.BirthDay}   Debt : {d.Debt} ");
            //        return true;
            //    }
            //    else
            //    {
            ...
            //var fullnameCheck = debtors
            //    .Where(d => Extetions.Check(d.FullName))
            //    .OrderBy(d => d.FullName)
            //    .ToList();
            //foreach (var item in fullnameCheck)
            //{
            ...
            //foreach (var x in q)
            //{
            //    Console.WriteLine($"Year  : {x.Value}");
            //    break;
            //}
